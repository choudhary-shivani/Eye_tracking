...
lgbm_models.append(LGBMRegressor(boosting_type='gbdt', class_weight=None, colsample_bytree=1.0,
              ...
              n_jobs=-1, num_leaves=80, objective=None, random_state=10,
              reg_alpha=0, reg_lambda=0, silent=True, subsample=1.0,
              subsample_for_bin=200000, subsample_freq=0))
# FFD Model
lgbm_models.append(LGBMRegressor(boosting_type='gbdt', class_weight=None, colsample_bytree=1.0,
              importance_type='split', lambda_l1=5.6, lambda_l2=15.6,
              learning_rate=0.1, max_depth=-1, min_child_samples=20,
              min_child_weight=0.001, min_split_gain=0.0, n_estimators=100,
...
# GPT Model
lgbm_models.append(LGBMRegressor(boosting_type='gbdt', class_weight=None, colsample_bytree=1.0,
              importance_type='split', lambda_l1=3.6, lambda_l2=6.6,
              learning_rate=0.1, max_depth=-1, min_child_samples=20,
              min_child_weight=0.001, min_split_gain=0.0, n_estimators=100,
...
# TRT Model
lgbm_models.append(LGBMRegressor(boosting_type='gbdt', class_weight=None, colsample_bytree=1.0,
              importance_type='split', lambda_l1=3.6, lambda_l2=0.6,
              learning_rate=0.1, max_depth=-1, min_child_samples=20,
              min_child_weight=0.001, min_split_gain=0.0, n_estimators=100,
...
#fixProp
lgbm_models.append(LGBMRegressor(boosting_type='gbdt', class_weight=None, colsample_bytree=1.0,
              importance_type='split', lambda_l1=9.6, lambda_l2=9.6,
              learning_rate=0.1, max_depth=-1, min_child_samples=20,
              min_child_weight=0.001, min_split_gain=0.0, n_estimators=100,
              n_jobs=-1, num_leaves=62, objective=None, random_state=10,
              reg_alpha=0.1, reg_lambda=0.0, silent=True, subsample=1.0,
